...
const ServiceNew = (props) => {
    ...
    return (
        <div>
            <form onSubmit={(e) => props.handleSubmitNewServiceForm(e)} onChange={(e) => props.handleOnChangeNewServiceForm(e)}>
                <div className="new-service-form">
                    <div className="profile-form-row">
                        ...
                        <textarea name="offeringDescription" placeholder="Describe the Service You Are Offering..." value={props.offeringDescription} />
